...
public class HomebuttonSearchIndexablesProvider extends SearchIndexablesProvider {
    private static final String TAG = "HomebuttonSearchIndexablesProvider";
    ...
    private static Object[] generateResourceRef(SearchIndexableResource sir) {
        ...
        ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = "org.lineageos.settings.homebutton";
